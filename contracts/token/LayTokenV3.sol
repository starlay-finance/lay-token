 ...
 * @author Lay
 */
contract LayTokenV3 is GovernancePowerDelegationERC20, VersionedInitializable {
  using SafeMath for uint256;

  string internal constant NAME = 'Lay Token';
  string internal constant SYMBOL = 'LAY';
  uint8 internal constant DECIMALS = 18;
  address internal constant VAULT = 0x43822E69852Ca59211bBC1Bd429feAb6A62A9f44;
